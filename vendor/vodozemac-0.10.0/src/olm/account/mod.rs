...
impl Account {
    ...
    // SECURE-MESSENGER-LAB PATCH 0001 — NOT AN UPSTREAM API.
    // Added for the secure-messenger-lab Phase-2 persistence validation
    ...
    /// returns `false` here.
    ///
    /// Both published and unpublished one-time keys are reported, as long as
